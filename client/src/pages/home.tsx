...
import EnhancedWordCard from "@/components/enhanced-word-card";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Enhanced Word Card Modal */}
      {selectedWordForCard && isWordCardModalOpen && (
        <EnhancedWordCard
          word={selectedWordForCard}
          onClose={() => {
            setIsWordCardModalOpen(false);
            setSelectedWordForCard(null);
          }}
